...
# Trend Micro Integration [![Awesome](https://img.shields.io/badge/SOCFortress-Worlds%20First%20Free%20Cloud%20SOC-orange)](https://www.socfortress.co/trial.html)
> Includes Python script to pull Trend Micro Alerts via their API and Wazuh rules for detection.
...
## [Trend Micro Security API](https://automation.deepsecurity.trendmicro.com/legacy-rest/11_1/index.html?env=dsaas#overview)
